                            ...
                            <div class="block-title" style="border: 1px solid #EEE;">
                                ...
                                <div class="links dropdown mobile-hide">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul  >
                                            <li role="presentation" @if($home_page_ctg_1_active_type == "new_arrival") class="active" @endif><a wire:click="changeFilterByType('new_arrival')">New Arrivals</a></a></li>
                                            <li role="presentation" @if($home_page_ctg_1_active_type == "top_selling") class="active" @endif><a wire:click="changeFilterByType('top_selling')">Top Selling</a></li>
                                            <li role="presentation" @if($home_page_ctg_1_active_type == "best_rated") class="active" @endif><a wire:click="changeFilterByType('best_rated')">Best Rated</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="actions">
                            ...
                            <div class="block-content">
                                <div class="col-categori" style="border: 1px solid #EEE;">
                                    <ul>
                                        ...
                                        <li><a style="cursor:pointer; @if($home_page_ctg_1_active_sub == $sub->id) color:#F05454;font-size:15px; @endif">{{ $sub->sub_category_name}}</a></li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="col-products tab-content">
                                    ...
                                    <div class="tab-pane active in  fade " id="floor1-1" role="tabpanel">
                                        ...
                                        @php 
                                            echo $total_product = count($home_page_ctg_1_products);
                                            $total_row = ceil($total_product / 2); 
                                            $sl = 0;
                                        @endphp
                                        @foreach($home_page_ctg_1_products as $product)
                                        @php
                                            if($loop->iteration == 1) { $sl = 0; }
                                            elseif($loop->iteration == 2) { $sl = 2; }
                                            elseif($loop->iteration == 3) { $sl = 4; }
                                        ...
                                        @endphp
                                            <div class="item">
                                                <div class=" product-item product-item-opt-2">
                                                    <div class="product-item-info">
                                                        <div class="product-item-photo">
                                                            @if($home_page_ctg_1_products[$sl]->product_page_main_image !="")
                                                                <img alt="product name" src="{{$backend_url}}/storage/{{ str_replace('public/', '', $home_page_ctg_1_products[$sl]->product_page_main_image) }}">
                                                            @else
                                                        ...
                                                        <div class="product-item-detail">
                                                            <strong class="product-item-name"><a href="">{{ $home_page_ctg_1_products[$sl]->product_name }}</a></strong>
                                                            <div class="clearfix">
                                                ...
                                                @if(isset($home_page_ctg_1_products[$sl + 1]))
                                                <div class="product-item product-item-opt-2">
                                                    <div class="product-item-info">
                                                        <div class="product-item-photo">
                                                            @if($home_page_ctg_1_products[$sl + 1]->product_page_main_image !="")
                                                                <img alt="product name" src="{{$backend_url}}/storage/{{ str_replace('public/', '', $home_page_ctg_1_products[$sl + 1]->product_page_main_image) }}">
                                                            @else
                                                                <img alt="product name" src="{{ asset('images/demo/420x512.jpg') }}">
                                                            @endif
                                                            <div class="product-item-actions">
                                                        ...
                                                        <div class="product-item-detail">
                                                            <strong class="product-item-name"><a href="">{{ $home_page_ctg_1_products[$sl + 1]->product_name }}</a></strong>
                                                            <div class="clearfix">
                                                                <div class="product-item-price">
