...
class HomePageCategory extends Component
{
    ...
    public function filter_1()
    {
        if($this->home_page_ctg_1 != "") {
            $products_1 = EcomProduct::select('id','product_name','price','product_page_main_image','user_rating','in_stock')->where('category_id',$this->home_page_ctg_1->id);
    ...
    public function filter_2()
    {
        if($this->home_page_ctg_2 != "") {
            $products_2 = EcomProduct::select('id','product_name','price','product_page_main_image','user_rating','in_stock')->where('category_id',$this->home_page_ctg_2->id);
    ...
    public function filter_3()
    {
        if($this->home_page_ctg_3 != "") {
            $products_3 = EcomProduct::select('id','product_name','price','product_page_main_image','user_rating','in_stock')->where('category_id',$this->home_page_ctg_3->id);
